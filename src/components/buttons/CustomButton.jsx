...
export const CustomButton = ({
  ...
  const primaryColor = "#0A6251"; // Change this to your preferred shade of black
    ...
    <button
      ...
      className={`${variant} shadow-md ${
        isDisabled
          ...
          : `${
              buttonVariant === "primary" &&
              `bg-[#0A6251] hover:bg-${primaryColor} text-white py-3 border-[1.5px] border-[#8DA4EA] cursor-pointer`
            } ${
              buttonVariant === "secondary" &&
