          ...
          <div className="grid grid-cols-2">
            ...
            <div className="mx-5 mt-10">
              <div className="flex justify-end gap-5">
                ...
                <div>
                  <button className="p-5 rounded-lg bg-[#1ACAA6] text-white">
                    Apply Now →
                  </button>
                </div>
              </div>
              ...
              <div className="flex justify-end items-center mt-10">
                <div className="p-5 border-2 rounded-lg w-8/12 bg-white border-[#E7F0FA] flex items-center gap-10 justify-between">
